...
var _datePicker = require('./date-picker/date-picker.component');
...
var DataGrid = (_dec = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps), (0, _reactIntl.injectIntl)(_class = _dec(_class = (_temp = _class2 = function (_React$PureComponent) {
  ...
  DataGrid.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      ...
      this.props.isBusy && _react2.default.createElement(_spinner.Spinner, null),
      actionBar,
      _react2.default.createElement(
  ...
  this.onCreateCellKeyDown = function (e) {
    if (e.keyCode === _keyCodes2.default.ENTER) {
      _this2.props.addNewItem(_this2.props.grid, _datagrid4.default.getColumnDefaultValues(_this2.props.columns));
          ...
          case _keyCodes2.default.LEFT:
            {
              ...
              if (columnInd !== -1) {
                ...
                var rowInd = rowIndex;
                while (disabled) {
                  if (e.keyCode === _keyCodes2.default.LEFT || e.keyCode === _keyCodes2.default.TAB && e.shiftKey) {
                    if (columnInd - 1 >= 0) {
                      columnInd -= 1;
                    } else if (rowInd - 1 >= 0) {
                  ...
                  var nextColumnKey = _datagrid4.default.getColumnKey(columns[columnInd]);
  ...
  this.getEditItemValue = function (rowIndex, col) {
    ...
    if (col.componentType === 'date') {
      return _this2.props.intl.formatDate(originalValue, { timeZone: 'UTC' });
  ...
  this.getFilterItemValue = function (col) {
    var val = _this2.props.filterData.get(_datagrid4.default.getColumnKey(col), '');
    if (val === null) {
      return '';
    }
    return val;
  ...
  this.generateColumns = function () {
    ...
    visibleColumns.forEach(function (col) {
      var column = {
        header: col.header,
        columnKey: _datagrid4.default.getColumnKey(col),
        ...
        style: _datagrid4.default.getCellStyleByCol(col)
      };
      if (col.valueKeyPath) {
      ...
      if (col.cell) {
        ...
        switch (col.valueType) {
          ...
          case 'date':
            column.cell = function (rowIndex) {
              return valueRender(rowIndex, function (v) {
                return _react2.default.createElement(_reactIntl.FormattedDate, _extends({ value: v }, col.renderComponentProps));
              });
            };
            break;
          case 'boolean':
                ...
                if (!column.cellEdit) {
                  column.cellEdit = function (rowIndex) {
                    return _react2.default.createElement(_datePicker2.default, _extends({
                      value: _this2.getEditItemValue(rowIndex, col),
                      onChange: _this2.onEditCellValueChange(rowIndex, col, editValueParser),
                      language: _this2.props.userLanguage,
                      inputRef: _this2.handleEditCellRef(rowIndex, col),
                      inputProps: {
                        tabIndex: tabIndex,
                        id: 'ocDatagridEditInput-' + _this2.props.grid.id + '-' + column.columnKey + '-' + rowIndex,
